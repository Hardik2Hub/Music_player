            ...
            if (snapshot.connectionState == ConnectionState.done) {
              return Container(
                  ...
                  child: ListView.builder(
                    itemCount: m.getallalbum.length,
                      ...
                      return InkWell(
                        onTap: () {
                          ...
                          for (int i = 0; i < m.song_list.value.length; i++) {
                            if (m.song_list.value[i].id ==
                                m.getallalbum[index].id) {
                                                ...
                                                children: [
                                                  Expanded(
                                                    child: Center(
                                                      child: Obx(() => Text(
                                                          maxLines: 1,
                                                          "${m.getallalbum.value[index].title}",
                                                          style: TextStyle(
                                                              fontSize: 10,
                                                              color: Colors
                                                                  .white))),
